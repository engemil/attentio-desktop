...
import 'package:attentio_desktop/features/dashboard/dashboard_page.dart';
...
/// typically don't have an AL-1 attached).
void main() {
  ...
  testWidgets('App boots and shows the dashboard', (tester) async {
    ...
    final hasEmpty = find
        .text('No devices found. Ensure your AL-1 is connected.')
        .evaluate()
        .isNotEmpty;
    expect(hasDevice || hasEmpty, isTrue,
